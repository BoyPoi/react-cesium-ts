...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        cesiumSource: paths.cesiumSource,
    ...
    plugins: [
      ...
      new CopyWebpackPlugin([ { from: paths.cesiumWorkers, to: 'Workers' } ]),
      new CopyWebpackPlugin([ { from: paths.cesiumSourceAssets, to: 'Assets' } ]),
      new CopyWebpackPlugin([ { from: paths.cesiumSourceWidgets, to: 'Widgets' } ]),
